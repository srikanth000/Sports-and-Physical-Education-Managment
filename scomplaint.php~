	...
	$s=0;
		...
		mysql_connect("localhost","root","");
		  ...
		  if(isset($_GET['id']))
			...
			$update=mysql_query("update request set remain=$remain,status=$status  where user='$u1' and (name='$g' and material='$m')");
...
<?php
		...
		$user=mysql_query("select * from cp ;");
...
<?php 
	...
	!-->
	<?php
				echo "<button type='submit' class='btn btn-success' name='accept'><a href='materi1.php?id=".$u['0']."'>Solve</a></button>";
				?>&nbsp;&nbsp;&nbsp;
